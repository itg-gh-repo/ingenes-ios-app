...
enum AppTheme {
    ...
    // Primary navy from Ingenes brand
    static let primaryBlue = Color(hex: "1B3A5C")       // Main brand navy
    static let primaryBlueDark = Color(hex: "122841")    // Darker shade
    static let primaryBlueLight = Color(hex: "2A5580")   // Lighter shade

    // Keep green for backwards compatibility
    static let primaryGreen = Color(hex: "1B3A5C")      // Maps to navy
    static let primaryGreenDark = Color(hex: "122841")   // Darker shade
    static let primaryGreenLight = Color(hex: "2A5580")  // Lighter shade

    static let accentColor = Color(hex: "4A90D9")        // Medical trust blue accent
